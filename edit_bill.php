...
if(!empty($_POST['customerName']) && $_POST['customerName'] && !empty($_POST['invoiceId']) && $_POST['invoiceId']) {	
	$db->updateInvoice($_POST);	
	header("Location:bill_list.php");	
}
if(!empty($_GET['update_id']) && $_GET['update_id']) {
	$invoiceValues = $db->getInvoice($_GET['update_id']);		
	$invoiceItems = $db->getInvoiceItems($_GET['update_id']);		
}
?>
<title>Edit Invoice | Billing System</title>
		    	...
		    	<div class="row">
		      		...
		      		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		      			...
		      			<div class="form-group">
							<input value="<?php echo $invoiceValues['order_receiver_name']; ?>" type="text" class="form-control" name="customerName" id="customerName" placeholder="Company Name" autocomplete="off">
						</div>
						<div class="form-group">
